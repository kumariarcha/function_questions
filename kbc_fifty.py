...
,["Charles Babbage"," Blaise Pascal"," Alan Turing","Lee De Forest","Hint option"]]

Hint_option=[["None of the above","All of the above"],["Bhopal","Delhi"],["Abacus","Pascaline"],["Blaise Pascal","charles Babage"]]
